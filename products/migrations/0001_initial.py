# Generated by Django 4.2 on 2023-12-20 14:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flag', models.CharField(choices=[('New', 'New'), ('Sale', 'SaLE'), ('Feature', 'Feature')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prodimage_product', to='products.product')),
            ],
        ),
    ]
